...
into_the_wild = media.Movie(
    ...
    Christopher McCandless abandons his possessions, gives his entire $24,000
    savings account to charity and hitchhikes to Alaska to live in the
...
moana = media.Movie(
    ...
    Maui reaches Moana's island, she answers the Ocean's call to seek out
...
in_time = media.Movie(
    ...
    only one more year, having the means to buy your way out of the situation
    is a shot at immortal youth. Here, Will Salas finds himself accused of
    murder and on the run with a hostage - a connection that becomes an
...
coco = media.Movie(
    "Coco",
    """Aspiring musician Miguel (voice of newcomer Anthony Gonzalez) teams up
    with charming trickster Hector (voice of Gael Garcia Bernal) on an
    extraordinary journey through the Land of the Dead.""",
    "https://upload.wikimedia.org/wikipedia/en/d/d7/Coco_%282017_film%29_logo.jpg",  # NOQA
    "https://www.youtube.com/watch?v=zNCz4mQzfEI")


the_perks = media.Movie(
    "The Perks of Being  Wallflower",
    """An introvert freshman is taken under the wings of two seniors who
...
beauty_beast = media.Movie(
    ...
    """An adaptation of the fairy tale about a monstrous-looking prince and
    a young woman who fall in love.""",
    "https://upload.wikimedia.org/wikipedia/pt/d/d6/Beauty_and_the_Beast_2017_poster.jpg",  # NOQA
